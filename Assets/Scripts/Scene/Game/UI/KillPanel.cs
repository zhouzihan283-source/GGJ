...
public class KillPanel : BasePanel
{
    ...
    private void Start()
    {
        ...
        {
            if (_imageObj1.activeInHierarchy) _role1.KillRole();
            if (_imageObj2.activeInHierarchy) _role2.KillRole();
            if (_imageObj3.activeInHierarchy) _role3.KillRole();
            if (_imageObj4.activeInHierarchy) _role4.KillRole();
            
            UIManager.Instance.HidePanel<KillPanel>();
