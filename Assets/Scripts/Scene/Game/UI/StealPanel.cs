...
/// 偷食物面板
/// </summary>
public class StealPanel : BasePanel
{
    ...
    private void Start()
    {
        ...
        {
            if (_imageObj1.activeInHierarchy) _role1.StealFood();
            if (_imageObj2.activeInHierarchy) _role2.StealFood();
            if (_imageObj3.activeInHierarchy) _role3.StealFood();
            if (_imageObj4.activeInHierarchy) _role4.StealFood();
            
            UIManager.Instance.HidePanel<StealPanel>();
